...
import { makeStyles } from "onyxia-ui/lib/ThemeProvider";
import { Text } from "onyxia-ui/Text/TextBase";
                    ...
                    case "collapses on scroll":
                        {
                            ...
                            helpCollapseParams.onIsCollapsedValueChange = isCollapsed => {
...
const useStyles = makeStyles<{
    ...
    (theme, { helperHeight, isTitleCollapsed, isHelpCollapsed }) => ({
        "root": {
            ...
            "marginBottom": !isTitleCollapsed || !isHelpCollapsed ? theme.spacing(3) : 0,
        },
        "title": {
            "display": "flex",
            "alignItems": "center",
